      ...
      <div className='content__container'>
        ...
        <form method='POST' className='field__container'>
          <div className='title_container'>
            <p>Name:</p>
            <input type='text' placeholder='Name the country' name='title' onChange={handleBlog} value={blog.title} />
          </div>
          <div className='blog__content'>
            <p>Description:</p>
            <textarea placeholder='Write about the country' name='description' className='blog_description' rows='20' column='10' onChange={handleBlog} value={blog.description}></textarea>
          </div>
